...
.product_images {
 ...
 .product_img.hover, .product_actions, .action_btn::before, .action_btn::after, .product_item:hover .product_img-default {
    opacity: 0;
 }
 ...
 .action_btn:hover::before, .action_btn:hover::after{
              ...
              <div class="product_item">
                <div class="product_banner">
                  ...
                  <div class="product_actions">
                    <a href="cart.php" class="action_btn" aria-label="Quick View">
